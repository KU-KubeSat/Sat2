...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspInit 0 */
    ...
    PF9     ------> UART7_CTS 
    */
#if 0 //NSS, (maybe RCS and CTS) pins PAY UART7
    GPIO_InitStruct.Pin = U7_PAY_RX_SPI5_NSS_Pin|U7_PAY_RTS_SPI5_MISO_Pin|U7_PAY_CTS_SPI5_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
#if 0 //RCS and CTS pins COMM UART8
    __HAL_RCC_GPIOD_CLK_ENABLE();
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX 
    */
    HAL_GPIO_DeInit(U3_RS485_S1_TX_GPIO_Port, U3_RS485_S1_TX_Pin);

    HAL_GPIO_DeInit(U3_RS485_S1_RX_GPIO_Port, U3_RS485_S1_RX_Pin);
