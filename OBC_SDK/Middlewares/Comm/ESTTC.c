...
#define ESTTC_NUMBER_READ_CMDS (40) //(39)                                       /* Number of read commands */
...
void Test_Send_Serial() {
    FILE* ComInterface = (FILE*)Esttc_usart_interfaces[ESTTC_PAYLOAD_INTEFACE];

    sprintf(print_buff[ESTTC_PAYLOAD_INTEFACE], "Test Serial Comms\n");

    ESTTC_CMD_CRC_Print_string(ComInterface, print_buff[ESTTC_PAYLOAD_INTEFACE]);
}
